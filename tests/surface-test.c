...
int main(void)
{
    ...
    while (running) {
        ...
        r_surface_blit(surface_1, SURFACE_1_SRCRECT, &(rect_t) { 100, 100, 300, 1000 });
        r_surface_blit(surface_1, SURFACE_1_SRCRECT, &(rect_t) { -100, 100, 30, 100 });
        r_surface_blit(surface_1, SURFACE_1_SRCRECT, &(rect_t) { 100, 100, 0, 100 });
        r_surface_blit(surface_1, SURFACE_1_SRCRECT, &(rect_t) { 100, 100, -10, 100 });
